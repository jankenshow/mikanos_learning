...
typedef struct
{
    ...
    Elf64_Addr e_entry;
    Elf64_Off e_phoff;      // プログラムヘッダへのファイル先頭からのオフセット
    Elf64_Off e_shoff;      // セクションヘッダへのファイル先頭からのオフセット
    Elf64_Word e_flags;     //
    Elf64_Half e_ehsize;    // ファイルヘッダのサイズ
    Elf64_Half e_phentsize; // プログラムヘッダの要素ひとつの大きさ
    Elf64_Half e_phnum;     // プログラムヘッダの要素数
    Elf64_Half e_shentsize; // セクションヘッダの要素ひとつの大きさ
